          ...
          <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
              ...
              <li class="nav-item lh-1 me-3 ms-4">
                <a class="github-button" href="https://github.com/E-bidir/e-bidir-html-admin-template-free"
                  data-icon="octicon-star" data-size="large" data-show-count="false"
                  aria-label="Star E-bidir/e-bidir-html-admin-template-free on GitHub">Remaining Credit
                  ...
                  <div class="card-body" id='bdy' style="margin-left:auto;margin-right:auto;">
                    <div class="col-md">
                      <div class="demo-inline-spacing">
                        ...
                        <div class="text-light medium fw-semibold" style="margin-left:auto;margin-right:auto;"
                          id='result'>Loading</div>
                      </div>
                    </div>
                  </div>
                  <?php
                      ...
                      <div class="col-lg-8 mb-4 order-0">
                        <div class="card">
                          <div class="d-flex align-items-end row">
                            <div class="col-sm-7">
                              <div class="card-body">
                                <h5 class="card-title text-primary" style="width: max-content;">Congratulations
                                  <?php echo $row['name'] ?>! 🎉
                                </h5>
                                <p class="mb-4">
                      ...
                      <div class="row mb-5">
                        <div class="col-md">
                          <div class="card mb-3">
                            <div class="row g-0">
                              <div class="col-md-4">
                                <img class="card-img card-img-left" src='<?php echo $row['profile']; ?>'
                                  alt="Card image" />
                              </div>
                              <div class="col-md-8">
                                <div class="card-body">
                                  ...
                                  <p class="card-text"><small class="text-muted">Account Created on
                                  ...
                                  <div class="card-body">
                                    ...
                                    <table>
                                      <tr>
                                        ...
                                        <td>
                                          <?php echo $row2['Number_of_dependents']; ?>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>Marriage Status:</td>
                                        <td>
                                          <?php echo $row2['Marriage_Status']; ?>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>Educational_Status:</td>
                                        <td>
                                          <?php echo $row2['Educational_Status']; ?>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>Criminal_record:</td>
                                        <td>
                                          <?php echo $row2['Criminal_record']; ?>
                                        </td>
                                      </tr>
                                    </table>
                                    </p>
                                    ...
                                    <div class="card-body">
                                      ...
                                      <table>
                                        <tr>
                                          ...
                                          <td>
                                            <?php echo $row3['field_of_employeement']; ?>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td>number of income:</td>
                                          <td>
                                            <?php echo $row3['number_of_income']; ?>
                                          </td>
                                        </tr>
                                        <tr>
                  ...
                  <footer class="content-footer footer bg-footer-theme">
                    <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                      ...
                      <div>
                        ...
                        <a href="https://E-bidir.com/demo/sneat-bootstrap-html-admin-template/documentation/"
                          target="_blank" class="footer-link me-4">Documentation</a>

                        <a href="https://github.com/E-bidir/sneat-html-admin-template-free/issues"
