                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item lh-1 me-3 ms-4">
                                <a class="github-button"
                                    ...
                                    aria-label="Star ThemeSelection/ThemeSelection-html-admin-template-free on GitHub">
                                    Credit
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class="nav nav-pills flex-column flex-md-row mb-3">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="javascript:void(0);"><i
                                                class="bx bx-link-alt me-1"></i> Economic Info</a>
                                    </li>
                                </ul>
                                <?php
                                $id = $_SESSION['id'];
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <form id="formAccountSettings" action="backend.php" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="hidden" id="originalfieldOfEmployment"
                                                    value="<?php echo $row3['field_of_employeement']; ?>">
                                                <div class="mb-3 col-md-6">
                                                    <label for="numberOfIncome" class="form-label">Number of
                                                        Income</label>
                                                    <input class="form-control" type="text" name="number_of_income"
                                                        id="numberOfIncome"
                                                        value="<?php echo $row3['number_of_income']; ?>" autofocus
                                                        readonly />
                                                </div>
                                                <input type="hidden" id="originalnumberOfIncome"
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input class="form-control date-picker" type="text"
                                                        id="yearOfEmployment" name="year"
                                                        value="<?php echo $row3['year']; ?>" placeholder="Select a date"
                                                        autofocus readonly data-toggle="flatpickr"
                                                        data-enable-time="false">
                                                </div>
                                                <input type="hidden" id="originalyearOfEmployment"
                                                    value="<?php echo $row3['year']; ?>">
                                                ...
                                                <input type="hidden" id="originalposition"
                                                    value="<?php echo $row3['position']; ?>">
                                                <div class="mb-3 col-md-6">
                                                    <label class="form-label" for="salary">Salary</label>
                                                    <div class="input-group input-group-merge">

                                                        <input type="number" id="basic-icon-default-salary"
                                                            class="form-control" placeholder="56790" aria-label="salary"
                                                            aria-describedby="basic-icon-default-salary" autofocus
                                                            readonly name="salary"
                                                            value="<?php echo $row3['salary']; ?>" />
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mt-2">
                                                <button type="submit" id="updateButton" name="update_economic"
                                    ...
                                    <div class="bs-toast toast toast-placement-ex m-2 bg-danger top-0 end-0"
