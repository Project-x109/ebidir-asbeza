            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="changepassword.php" method="POST">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input required type="password" class="form-control" id="confirmpassword"
                                    name="confirmpassword" placeholder="Confirm Password" autofocus />
                            </div>
                            <button type="submit" id="submit-btn" name="new_password"
                                class="btn btn-primary d-grid w-100">Change Password</button>
                        </form>
                        <div class="text-center">
                            <a href="index.php" onclick="return validateForm()"
