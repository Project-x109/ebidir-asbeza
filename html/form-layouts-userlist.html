...
<body>
            ...
            <ul class="navbar-nav flex-row align-items-center ms-auto">
              ...
              <li class="nav-item lh-1 me-3 ms-4">
                <a class="github-button" href="https://github.com/themeselection/sneat-html-admin-template-free"
                  ...
                  aria-label="Star themeselection/sneat-html-admin-template-free on GitHub">Score</a>
              </li>
  ...
  <script src="../assets/js/tablefunctionalities.js">// JavaScript for pagination and search functionality</script>
