...
<head>
    ...
    <title>Horizontal Layouts - Forms | e-bidir - Bootstrap 5 HTML Admin Template - Pro</title>
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item lh-1 me-3">
                                <a class="github-button" href="https://github.com/ThemeSelection/e-bidir-html-admin-template-free" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star ThemeSelection/e-bidir-html-admin-template-free on GitHub">Star</a>
                            </li>
