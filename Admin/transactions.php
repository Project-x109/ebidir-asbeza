                                ...
                                <div class="card">
                                    ...
                                    if (!empty($search)) {
                                        ...
                                        $sql = "SELECT * FROM `transactions` INNER JOIN users ON users.user_id=transactions.user_id 
                                                WHERE (users.name LIKE ? OR transactions.transaction_id LIKE ? OR transactions.loan_id LIKE ? OR 
                                        ...
                                        $sql = "SELECT * FROM `transactions` INNER JOIN users ON users.user_id=transactions.user_id LIMIT ?, ?";
                                        $stmt = $conn->prepare($sql);
                                    ...
                                    if (!empty($search)) {
                                        ...
                                        WHERE (users.name LIKE ? OR transactions.transaction_id LIKE ? 
                                        ...
                                        OR transactions.credit_level LIKE ? OR transactions.updatedBy 
                                        LIKE ? OR transactions.updatedOn LIKE ?)";
